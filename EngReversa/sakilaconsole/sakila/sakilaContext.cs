...
namespace sakilaconsole.sakila
{
    public partial class sakilaContext : DbContext
    {
        ...
        public virtual DbSet<ActorClone> ActorClones { get; set; }
        ...
        public virtual DbSet<FilmWithCategory> FilmWithCategories { get; set; }
        ...
        public virtual DbSet<Primeira> Primeiras { get; set; }
        ...
        public virtual DbSet<Segundum> Segunda { get; set; }
        public virtual DbSet<StaffList> StaffLists { get; set; }
        public virtual DbSet<Store> Stores { get; set; }
        public virtual DbSet<Terceira> Terceiras { get; set; }
        public virtual DbSet<Top10Customer> Top10Customers { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActorClone>(entity =>
            {
                entity.HasKey(e => e.ActorId)
                    .HasName("PRIMARY");

                entity.ToTable("actor_clone");
            ...
            modelBuilder.Entity<Film>(entity =>
            {
                ...
                entity.HasIndex(e => e.Description, "description_index");
            ...
            modelBuilder.Entity<FilmWithCategory>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("film_with_categories");
            ...
            modelBuilder.Entity<MoviesLanguage>(entity =>
            {
                ...
                entity.ToView("movies_languages");
            ...
            modelBuilder.Entity<Primeira>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("primeira");
            ...
            modelBuilder.Entity<Segundum>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("segunda");
            ...
            modelBuilder.Entity<Terceira>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("terceira");
            });
            ...
            modelBuilder.Entity<Top10Customer>(entity =>
            {
                ...
                entity.ToView("top_10_customers");
                ...
                entity.Property(e => e.TotalAmountSpent)
                    .HasColumnType("decimal(27,2)")
                    .HasColumnName("total_amount_spent");
            });
