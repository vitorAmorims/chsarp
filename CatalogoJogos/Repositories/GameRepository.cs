...
namespace CatalogoJogos.Repositories
{
    public class GameRepository : IGameRepository
    {
        ...
        {
            {Guid.Parse("f6e36dae-fcbb-4282-959b-abec56e80f9c"), new Game{ Id = Guid.Parse("f6e36dae-fcbb-4282-959b-abec56e80f9c"), Name = "God of War", Producer="Sony Interactive", Price=202.50}},
            ...
            {Guid.Parse("dfc0c6c3-c206-4f6c-ad51-75bc7bb5a6f4"), new Game{ Id = Guid.Parse("dfc0c6c3-c206-4f6c-ad51-75bc7bb5a6f4"), Name = "Grand Theft Auto", Producer="Rockstar North", Price=310.50}},
        ...
        public void Dispose()
        {
            System.Console.WriteLine("dispose repository");
        }
        ...
        public Task<Game> GetGameNameProducer(string name, string producer)
        {
            ...
            if (games.Any(e => e.Value.Name.Equals(name) && e.Value.Producer.Equals(producer)))
            {
                return null;
            }
